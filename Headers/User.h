...
public:
    ...
    virtual QWidget* createWidget(QWidget *parent, User* user) = 0 ; // we will override this method in derived classes to set the user interface depending on the type of user
    virtual QWidget* createScheduleWidget(QWidget *parent, User *user) = 0 ; // we will override this method in derived classes to set the schedule interface depending on the type of user
